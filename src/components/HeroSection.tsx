...
const HeroSection: React.FC = () => {
  ...
  return (
    <main className="w-full min-h-screen sm:min-h-[600px] md:min-h-[700px] lg:min-h-[786px] relative mt-16 sm:mt-20 md:mt-24 lg:mt-[100px] bg-white flex items-center justify-center py-8 sm:py-12 md:py-16 lg:py-8 lg:justify-start lg:items-start lg:pl-[120px] overflow-hidden">
      ...
      {/* Content Card */}
      <section 
        className="relative z-10 w-full max-w-lg mx-4 sm:max-w-xl sm:mx-6 md:max-w-2xl lg:w-[584px] lg:mx-0 lg:mt-16 shadow-lg sm:shadow-xl lg:shadow-[4px_4px_20px_0_rgba(0,132,255,0.30)] bg-white rounded-2xl px-6 py-8 sm:px-8 sm:py-10 md:px-10 md:py-12 lg:px-12 lg:py-14 lg:min-h-[680px]"
